...
<div align="center">
  ...
  <img
    src="https://skillicons.dev/icons?i=ts,react,cs,dotnet,go,graphql,postgres,mongodb,redis,firebase,jest,kafka,rabbitmq,aws,grafana,docker,kubernetes,terraform,git,github,vscode,rider,webstorm,androidstudio,figma,apple,windows&perline=7"
    alt="main-stack"
  />
