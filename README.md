...
<ul>
  ...
  <li>I am <b>Software Engineer</b> with experience in TypeScript, React Native, Kotlin, C#, .NET, Java (Spring Boot), Node.js (NestJS), SQL/NoSQL databases and AWS.</li>
</ul>
...
<div align="center">
  ...
  <img
    src="https://skillicons.dev/icons?i=ts,react,kotlin,ktor,cs,dotnet,graphql,postgres,mongodb,redis,firebase,jest,kafka,rabbitmq,aws,grafana,docker,kubernetes,terraform,git,github,vscode,rider,idea,androidstudio,figma,apple,windows&perline=7"
    alt="main-stack"
  />
