...
<img
  src="https://skillicons.dev/icons?i=js,ts,react,redux,cs,dotnet,graphql,kafka,rabbitmq,postgres,mongodb,redis,firebase,azure,docker,git,github,npm,vscode,visualstudio,rider,webstorm,apollo,figma,&perline=6"
  alt="stack"
/>
