...
<img
  src="https://skillicons.dev/icons?i=js,ts,react,kotlin,ktor,cs,dotnet,graphql,kafka,rabbitmq,postgres,mongodb,redis,azure,docker,vercel,git,github,gitlab,vscode,visualstudio,idea,rider,figma&perline=8"
  alt="stack"
/>
