...
<ul>
  ...
  <li>I am <b>Mobile</b>, <b>FullStack .NET</b> and <b> Backend Developer</b>, with experience in React Native (TypeScript), .NET (C#), Node.js (NestJS) and SQL (PostgreSQL)/NoSQL (MongoDB and Redis) databases.</br></li>
</ul>
