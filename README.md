...
<img
  src="https://skillicons.dev/icons?i=js,ts,react,cs,dotnet,python,flask,graphql,kafka,rabbitmq,postgres,mongodb,redis,azure,docker,vercel,git,github,gitlab,vscode,visualstudio,pycharm,rider,figma&perline=8"
  alt="stack"
/>
