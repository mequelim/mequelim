...
<ul>
  ...
  <li>I am <b>Software Engineer</b> with experience in TypeScript, React Native, Kotlin, C#, .NET, SQL/NoSQL databases and AWS.</br></li>
</ul>
...
<div align="center">
  ...
  <img
    src="https://skillicons.dev/icons?i=ts,react,kotlin,ktor,cs,dotnet,graphql,postgres,mongodb,redis,firebase,jest,kafka,rabbitmq,aws,grafana,docker,kubernetes,terraform,git,github,vscode,rider,webstorm,androidstudio,figma,apple,windows&perline=7"
    alt="main-stack"
  />
