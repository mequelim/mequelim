...
<img
  src="https://skillicons.dev/icons?i=ts,react,cs,dotnet,nodejs,nestjs,graphql,kafka,rabbitmq,prisma,postgres,mongodb,redis,firebase,grafana,aws,docker,git,github,vscode,visualstudio,rider,webstorm,androidstudio,apollo,figma,apple,windows&perline=7"
  alt="stack"
/>
