...
<img
  src="https://skillicons.dev/icons?i=ts,react,kotlin,ktor,cs,dotnet,graphql,kafka,rabbitmq,postgres,mongodb,redis,firebase,azure,docker,git,github,vscode,visualstudio,idea,rider,webstorm,androidstudio,figma,&perline=8"
  alt="stack"
/>
